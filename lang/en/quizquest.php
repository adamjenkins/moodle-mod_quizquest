...
$string['coursequestionbank'] = 'Course question bank ({$a})';
$string['enterfullscreen'] = 'Enter fullscreen';
$string['error:bankaccessdenied'] = 'You do not have permission to use that question bank.';
$string['error:closedon'] = 'This activity closed on {$a}.';
$string['error:gradescalenotsupported'] = 'Quiz Quest does not support grading with a scale. Choose a point value, or "None".';
...
$string['openclosedatesupdated'] = 'Quest open and close dates updated';
...
$string['privacy:metadata:quizquest_attempts:correctpoolqueue'] = 'The generic correct-answer feedback entries not yet shown during the attempt.';
$string['privacy:metadata:quizquest_attempts:incorrectpoolqueue'] = 'The generic incorrect-answer feedback entries not yet shown during the attempt.';
...
$string['privacy:metadata:quizquest_responses:feedbacktext'] = 'The feedback text shown to the user for this turn.';
...
$string['privacy:metadata:quizquest_responses:stepmsgafter'] = 'The narrative text shown after the feedback for this turn, if any.';
$string['privacy:metadata:quizquest_responses:stepmsgbefore'] = 'The narrative text shown before the feedback for this turn, if any.';
...
$string['questionbank_help'] = 'The question bank to draw questions from: any question bank activity in this course, plus any banks shared to other courses or the whole site that you have permission to use. Choosing a bank refreshes the category list below.';
$string['questioncategory'] = 'Question category';
$string['questioncategory_help'] = 'Questions are drawn at random from this category in the selected question bank, preferring questions the student has not seen before. Multiple choice questions are presented as choice buttons; short answer questions accept a typed response.';
